...
const en = {
  ...
  updateFailureCdkRequired: "Enter a MirrorChyan redemption code first.",
  updateFailureCdkInvalid: "MirrorChyan rejected the redemption code.",
  updateFailureCdkExpired: "The MirrorChyan redemption code has expired.",
  updateFailureCdkDisabled: "The MirrorChyan redemption code is disabled.",
  updateFailureCdkQuotaExceeded:
    "The MirrorChyan redemption code has used up its download quota.",
  updateFailureCdkMismatch:
    "The MirrorChyan redemption code does not cover this resource.",
...
const zh: Record<MessageKey, string> = {
  ...
  updateFailureCdkRequired: "请先填写 Mirror酱兑换码。",
  updateFailureCdkInvalid: "Mirror酱拒绝了该兑换码。",
  updateFailureCdkExpired: "Mirror酱兑换码已过期。",
  updateFailureCdkDisabled: "Mirror酱兑换码已被禁用。",
  updateFailureCdkQuotaExceeded: "Mirror酱兑换码的下载额度已用完。",
  updateFailureCdkMismatch: "Mirror酱兑换码不适用于该资源。",
